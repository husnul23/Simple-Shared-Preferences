...
class FormUserPreferenceActivity : AppCompatActivity(), View.OnClickListener {
    ...
    override fun onClick(p0: View) {
        if (p0.id == R.id.btn_save) {
            ...
            val isLoveMilan = rg_love_mu.checkedRadioButtonId == R.id.rb_yes
            ...
            saveUser(name, email, age, phoneNo, isLoveMilan)
    ...
    private fun saveUser(name: String, email: String, age: String, phoneNo: String, isLoveMilan: Boolean) {
